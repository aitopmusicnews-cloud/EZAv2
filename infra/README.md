...
```bash
aws ssm put-parameter --name /music-video-studio/hackathon/AGNES_API_KEY \
  --value 'your-agnes-api-key' --type SecureString --region us-west-2
